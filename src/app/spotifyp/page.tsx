...
export default function spotifyp(){
    ...
    <div className="flex items-center justify-center">
        <img src="https://i.scdn.co/image/ab6775700000ee8570dd928d108eab4eba7caf3b" alt="user" className="w-20 h-20 object-cover rounded-full border border-green-500 cursor-pointer mr-4" />
    </div>
