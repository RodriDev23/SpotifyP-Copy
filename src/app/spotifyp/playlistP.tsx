    ...
    <div className="w-full">
      <div className="flex items-center justify-center mt-4">
        <div className="flex items-center bg-black border border-green-500 text-green-500 rounded-md p-4 w-[90%] md:w-[50%] lg:w-[30%] mt-5">
          <div>
            <img src={sliderItems[currentIndex].songCover} alt="song cover" className="w-16 h-16 rounded-full object-cover mb-48" />
          </div>
          <div className="flex flex-col flex-grow">
            ...
            <div className="flex items-center">
              <img src={sliderItems[currentIndex].albumPic} alt="album pic" className="h-28 w-28 object-cover mr-3 max-w-[10rem]  ml-16" />
            </div>
